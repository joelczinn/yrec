...
This script runs one rotation case on different stellar mass inputs 
...
master_output_dir = "/tracks/2.0000D0PMMA_1.0000D0PMMB_2.2000D-1PMMM/" #directory for rotevol outputs 
